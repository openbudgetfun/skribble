...
5. The `publisher` environment publishes either all seven main-group packages in dependency order or the single companion package identified by the tag namespace.
