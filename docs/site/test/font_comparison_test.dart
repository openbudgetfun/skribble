  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(specimens.map((text) => text.style!.fontFamily).toSet(), {
        ...
        'packages/skribble_font_recursive/SkribbleMonoGentle',
        'packages/skribble_font_recursive/SkribbleMonoPlayful',
        'packages/skribble_font_recursive/SkribbleMonoExpressive',
        'packages/skribble_font_recursive/SkribbleGentle',
        'packages/skribble_font_recursive/SkribblePlayful',
        'packages/skribble_font_recursive/Skribble',
        'packages/skribble_font_recursive/SkribbleLinearGentle',
        'packages/skribble_font_recursive/SkribbleLinearPlayful',
        'packages/skribble_font_recursive/SkribbleLinearExpressive',
      });
