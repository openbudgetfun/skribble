...
| ----------------------- | ------------------------------------------------- | --: | ---: | ----------------------: | ----------- | ---------------------------------------------------- |
| MaterialApp + ThemeData | `WiredMaterialApp` / `.router` + `WiredThemeData.toThemeData()` |  ✅ |   ✅ | ✅ (`app.dart`)         | implemented | Keeps Material theming and `WiredTheme` synchronized across classic and router bootstrapping |
