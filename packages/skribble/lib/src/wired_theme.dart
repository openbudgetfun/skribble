...
///
/// Based on Recursive Casual with expressively warped TrueType outlines.
...
class WiredThemeData {
  ...
  /// Coordinated border and font settings. Defaults to expressive ink.
  ...
  WiredThemeData({
    ...
    this.roughnessLevel = WiredRoughness.expressive,
    this._roughness,
    this._fontFamily,
    this._drawConfig,
  });
...
class WiredTheme extends HookWidget {
  ...
  /// Returns the nearest Wired theme, or the expressive default.
