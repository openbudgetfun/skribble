...
void main() {
  ...
  group('WiredCupertinoTextField', () {
    ...
    testWidgets('shows placeholder text', (tester) async {
      await tester.pumpWidget(buildSubject(placeholder: 'Enter name'));
    ...
    testWidgets('renders prefix widget', (tester) async {
      await tester.pumpWidget(
        buildSubject(prefix: const Icon(Icons.search, key: Key('prefix'))),
      );
    ...
    testWidgets('renders suffix widget', (tester) async {
      await tester.pumpWidget(
        buildSubject(suffix: const Icon(Icons.clear, key: Key('suffix'))),
      );
