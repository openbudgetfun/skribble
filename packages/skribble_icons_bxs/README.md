...
Artwork comes from **Boxicons** ([homepage](https://boxicons.com)) under **MIT**, warped
...
`kBxsIcons` maps codepoints to `WiredSvgIconData`.
`kBxsIconCodePoints` maps identifiers to codepoints. Names include upstream
...
The icon artwork in this package is MIT, copyright Boxicons and its
contributors.
