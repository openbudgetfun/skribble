...
Artwork comes from **Lucide** ([homepage](https://lucide.dev)) under **ISC**, warped
...
`kLucideIcons` maps codepoints to `WiredSvgIconData`.
`kLucideIconCodePoints` maps identifiers to codepoints. Names include upstream
...
The icon artwork in this package is ISC, copyright Lucide and its
contributors.
