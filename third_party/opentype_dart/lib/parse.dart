...
class Parser {
  ...
  Map<String, dynamic>? parseValueRecord(valueFormat) {
    ...
    if ((valueFormat & 0x0010) != 0) {
      valueRecord["xPlaDevice"] = null;
      this.parseShort();
    }
    if ((valueFormat & 0x0020) != 0) {
      valueRecord["yPlaDevice"] = null;
      this.parseShort();
    }
    if ((valueFormat & 0x0040) != 0) {
      valueRecord["xAdvDevice"] = null;
      this.parseShort();
    }
    if ((valueFormat & 0x0080) != 0) {
      valueRecord["yAdvDevice"] = null;
      this.parseShort();
    }
    ...
    return this.parsePointer(Parser.recordList({
          ...
          "script": Parser.pointer({
            ...
            "langSysRecords": Parser.recordList(
                {"tag": Parser.tag, "langSys": Parser.pointer(langSysTable)},
                null)
          })
        }, null)) ??
        [];
  ...
  parseLookupList(lookupTableParsers) {
    ...
    return this.parsePointer(Parser.list(Parser.pointer((scope) {
          ...
          argument(1 <= lookupType && lookupType <= 9,
          ...
          return {
            ...
            "subtables": scope.parseList(
                Parser.pointer(lookupTableParsers[lookupType]), null),
  ...
  parseFeatureVariationsList() {
    return this.parsePointer32(() {
          ...
          argument(majorVersion == 1 && minorVersion < 1,
