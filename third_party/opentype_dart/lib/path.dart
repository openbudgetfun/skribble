...
class Path {
  ...
  moveTo(num x, num y) {
    this.commands.add({"type": 'M', "x": x, "y": y});
  }

  lineTo(x, y) {
    this.commands.add({"type": 'L', "x": x, "y": y});
  }
  ...
  quadraticCurveTo(x1, y1, x, y) {
    this.commands.add({"type": 'Q', "x1": x1, "y1": y1, "x": x, "y": y});
  }
    ...
    for (var i = 0; i < this.commands.length; i++) {
      ...
      switch (cmd["type"]) {
        ...
        case 'Q':
          ...
          break;
        case 'C':
          box.addBezier(prevX, prevY, cmd["x1"], cmd["y1"], cmd["x2"],
              cmd["y2"], cmd["x"], cmd["y"]);
          prevX = cmd["x"];
          prevY = cmd["y"];
          break;
