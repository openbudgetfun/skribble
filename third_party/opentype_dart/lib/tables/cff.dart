...
parseCFFTable(data, start, Font font, opt) {
  ...
  if (font.isCIDFont) {
    ...
    fdArrayOffset += start;
    Map<String, dynamic> fdArrayIndex =
        parseCFFIndex(data, fdArrayOffset, null);
...
makeTopDictIndex(topDict) {
  var t = Record(
      ...
      null);
  t.topDicts = [
    {"name": 'topDict_0', "type": 'TABLE', "value": topDict}
  ];
  return t;
}
...
makeStringIndex(strings) {
  ...
  for (var i = 0; i < strings.length; i += 1) {
    t.strings
        .push({"name": 'string_${i}', "type": 'STRING', "value": strings[i]});
  }
