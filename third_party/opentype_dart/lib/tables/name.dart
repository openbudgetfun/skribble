  ...
  for (var i = 0; i < count; i++) {
    ...
    if (encoding != null && language != null) {
      ...
      if (encoding == utf16) {
        ...
        text =
            decode_MACSTRING(data, stringOffset + offset, byteLength, encoding);
      }
...
makeNameTable(names, ltag) {
  ...
  for (var i = 0; i < nameIDs.length; i++) {
    ...
    for (var lang in translations) {
      ...
      if (winLanguage != null) {
        ...
        nameRecords.add(makeNameRecord(
            3, 1, winLanguage, nameID, winName.length, winNameOffset));
      }
    }
  }
  ...
  for (var r = 0; r < nameRecords.length; r++) {
    t.fields.push(
        {"name": 'record_${r}', "type": 'RECORD', "value": nameRecords[r]});
  }
