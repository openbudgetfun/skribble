...
final LIMIT16 =
    32768; // The limit at which a 16-bit number switches signs == 2^15
final LIMIT32 =
    2147483648; // The limit at which a 32-bit number switches signs == 2 ^ 31
...
encode_CHARARRAY(v) {
  if (v == null) {
    v = '';
    print(
        'null CHARARRAY encountered and treated as an empty string. This is probably caused by a missing glyph name.');
  }
  var b = [];
